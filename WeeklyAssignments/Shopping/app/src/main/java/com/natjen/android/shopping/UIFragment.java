...
public class UIFragment extends Fragment implements Observer {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button deleteItem = view.findViewById(R.id.deleteItem_button);
                ...
                if (mItemsDB.dbSize() != 0) {
                    if (!what.isEmpty()) {
                        if (item != null && item.getWhat().equals(what)) {
                            ...
                            Toast.makeText(getActivity(), R.string.noItem_toast, Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(getActivity(), R.string.typeWhat_toast, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    mWhatItem.setText("");
                    Toast.makeText(getActivity(), R.string.emptyList_toast, Toast.LENGTH_SHORT).show();
                }
